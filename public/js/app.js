...
var updateCart = function updateCart(fish) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', fish).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var fish = JSON.parse(btn.dataset.fish);
    updateCart(fish);
  });
});
...
var socket = io(); // Join socket rooms
